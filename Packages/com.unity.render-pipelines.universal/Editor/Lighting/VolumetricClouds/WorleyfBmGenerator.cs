...
internal class WorleyfBmGenerator : MonoBehaviour
{
    ...
    static Texture2D GenerateWorleyfBm(int width, int height, int depth, NoiseType noiseType)
    {
        ...
        ComputeShader worleyCS = (ComputeShader)AssetDatabase.LoadAssetAtPath("Packages/com.unity.render-pipelines.universal/Editor/Lighting/VolumetricClouds/WorleyEvaluator.compute", typeof(ComputeShader));
