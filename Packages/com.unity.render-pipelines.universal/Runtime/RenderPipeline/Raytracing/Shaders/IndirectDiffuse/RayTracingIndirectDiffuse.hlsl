...
#include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/HDStencilUsage.cs.hlsl"

#include "Packages/com.unity.render-pipelines.core/ShaderLibrary/BSDF.hlsl"
#include "Packages/com.unity.render-pipelines.universal/Runtime/Material/PreIntegratedFGD/PreIntegratedFGD.hlsl"
#include "Packages/com.unity.render-pipelines.core/ShaderLibrary/CommonLighting.hlsl"
#include "Packages/com.unity.render-pipelines.core/ShaderLibrary/ImageBasedLighting.hlsl"
#include "Packages/com.unity.render-pipelines.universal/Runtime/Lighting/LightLoop/LightLoopDef.hlsl"
#include "Packages/com.unity.render-pipelines.universal/Runtime/Lighting/LightEvaluation.hlsl"
#include "Packages/com.unity.render-pipelines.universal/Runtime/Material/MaterialEvaluation.hlsl"
#include "Packages/com.unity.render-pipelines.universal/Runtime/ShaderLibrary/ShaderVariablesGlobal.hlsl"
...
#include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/RayTracingLightCluster.hlsl"
...
#include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/RaytracingSampling.hlsl"
#include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/RayTracingCommon.hlsl"
#include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/Common/RaytracingHelpers.hlsl"
#include "Packages/com.unity.render-pipelines.universal/Runtime/Lighting/ScreenSpaceLighting/ScreenSpaceLighting.hlsl"
#include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/Common/AtmosphericScatteringRayTracing.hlsl"
#include "Packages/com.unity.render-pipelines.universal/Runtime/Debug/RayCountManager.cs.hlsl"
#include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/RayTracingFallbackHierarchy.cs.hlsl"

// GI includes
#include "Packages/com.unity.render-pipelines.universal/Runtime/Material/BuiltinGIUtilities.hlsl"
