...
//
// UnityEngine.Rendering.Universal.StackLit+BSDFData:  static fields
//
...
//
// UnityEngine.Rendering.Universal.StackLit+SurfaceData:  static fields
//
...
#define DEBUGVIEW_STACKLIT_SURFACEDATA_USE_PROFILE_IOR (1105)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_SPECULAR_COLOR (1106)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_NORMAL (1107)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_NORMAL_VIEW_SPACE (1108)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_GEOMETRIC_NORMAL (1109)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_GEOMETRIC_NORMAL_VIEW_SPACE (1110)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_COAT_NORMAL (1111)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_COAT_NORMAL_VIEW_SPACE (1112)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_BENT_NORMAL (1113)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_BENT_NORMAL_VIEW_SPACE (1114)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_SMOOTHNESS_A (1115)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_SMOOTHNESS_B (1116)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_LOBE_MIXING (1117)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_HAZINESS (1118)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_HAZE_EXTENT (1119)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_HAZY_GLOSS_MAX_DIELECTRIC_F0_WHEN_USING_METALLIC_INPUT (1120)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_TANGENT (1121)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_ANISOTROPY_A (1122)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_ANISOTROPY_B (1123)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_IRIDESCENCE_IOR (1124)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_IRIDESCENCE_LAYER_THICKNESS (1125)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_IRIDESCENCE_MASK (1126)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_IRIDESCENCE_COAT_FIXUP_TIR (1127)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_IRIDESCENCE_COAT_FIXUP_TIR_CLAMP (1128)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_COAT_SMOOTHNESS (1129)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_COAT_MASK (1130)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_COAT_IOR (1131)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_COAT_THICKNESS (1132)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_COAT_EXTINCTION_COEFFICIENT (1133)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_DIFFUSION_PROFILE_HASH (1134)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_SUBSURFACE_MASK (1135)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_TRANSMISSION_MASK (1136)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_THICKNESS (1137)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_SPECULAR_OCCLUSION_FROM_CUSTOM_INPUT (1138)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_SPECULAR_OCCLUSION_FIXUP_VISIBILITY_RATIO_THRESHOLD (1139)
...
//
// UnityEngine.Rendering.Universal.StackLit+MaterialFeatureFlags:  static fields
//
...
// Generated from UnityEngine.Rendering.Universal.StackLit+BSDFData
// PackingRules = Exact
struct BSDFData
{
...
// Generated from UnityEngine.Rendering.Universal.StackLit+SurfaceData
// PackingRules = Exact
struct SurfaceData
{
    uint materialFeatures;
...
void GetGeneratedSurfaceDataDebug(uint paramId, SurfaceData surfacedata, inout float3 result, inout bool needLinearToSRGB)
{
    switch (paramId)
    {
        ...
        case DEBUGVIEW_STACKLIT_SURFACEDATA_DIELECTRIC_IOR:
            ...
            break;
        case DEBUGVIEW_STACKLIT_SURFACEDATA_USE_PROFILE_IOR:
            result = (surfacedata.useProfileIor) ? float3(1.0, 1.0, 1.0) : float3(0.0, 0.0, 0.0);
            break;
