Shader "HDRP/LayeredLitTessellation"
{
    Properties
    {
        ...
        [Enum(UnityEditor.Rendering.Universal.TransparentCullMode)] _TransparentCullMode("_TransparentCullMode", Int) = 2 // Back culling by default
        [Enum(UnityEditor.Rendering.Universal.OpaqueCullMode)] _OpaqueCullMode("_OpaqueCullMode", Int) = 2 // Back culling by default
    ...
    // #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/Lit.cs.hlsl"
    #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/LitProperties.hlsl"
    ...
    SubShader
    {
        ...
        Tags{ "RenderPipeline" = "UniversalPipeline" "RenderType" = "HDLitShader" }
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/ShaderLibrary/PickingSpaceTransforms.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/Lit.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/ShaderPass/LitDepthPass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassDepthOnly.hlsl"
        ...
        Pass
        {
            ...
            #ifdef DEBUG_DISPLAY
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Debug/DebugDisplay.hlsl"
            #endif
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/Lit.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"

            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassGBuffer.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassLightTransport.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #else
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/ShaderPass/LitMotionVectorPass.hlsl"
            #endif
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassMotionVectors.hlsl"
        ...
        Pass
        {
            ...
            #endif
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Lighting/Lighting.hlsl"
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Lighting/LightLoop/LightLoopDef.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/Lit.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Lighting/LightLoop/LightLoop.hlsl"

            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassForward.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/Lit.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/ShaderPass/LitConstantPass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassConstant.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassFullScreenDebug.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/RaytracingMacros.hlsl"

            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/ShaderVariablesRaytracing.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/ShaderVariablesRaytracingLightLoop.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Lighting/Lighting.hlsl"
            ...
            #define HAS_LIGHTLOOP
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/Lit.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/LitRaytracing.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/RaytracingLightLoop.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassRaytracingIndirect.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/RaytracingLightLoop.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassRaytracingForward.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/Deferred/RaytracingIntersectonGBuffer.hlsl"

            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/Lit.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/StandardLit/StandardLit.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/LitRaytracing.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassRaytracingGBuffer.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/Lit.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassRaytracingVisibility.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/SubSurface/RayTracingIntersectionSubSurface.hlsl"

            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/Lit.hlsl"

            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/RayTracingCommon.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassRayTracingSubSurface.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/Raytracing/Shaders/RayTracingCommon.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassRaytracingDebug.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/Lit.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/LayeredLit/LayeredLitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Lit/LitPathTracing.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassPathTracing.hlsl"
    ...
    CustomEditor "UnityEditor.Rendering.Universal.LayeredLitGUI"
}
