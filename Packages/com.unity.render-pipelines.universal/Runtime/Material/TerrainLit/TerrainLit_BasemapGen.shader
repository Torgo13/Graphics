Shader "Hidden/HDRP/TerrainLit_BasemapGen"
{
    ...
    SubShader
    {
        Tags { "RenderPipeline" = "UniversalPipeline" "SplatCount" = "8" }
        ...
        #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/TerrainLit/TerrainLitSurfaceData.hlsl"
