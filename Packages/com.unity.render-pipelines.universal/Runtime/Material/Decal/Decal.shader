Shader "HDRP/Decal"
{
    ...
    SubShader
    {
        ...
        Pass // 0
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Decal/DecalProperties.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Decal/Decal.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Decal/ShaderPass/DecalSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Decal/DecalData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassDecal.hlsl"
