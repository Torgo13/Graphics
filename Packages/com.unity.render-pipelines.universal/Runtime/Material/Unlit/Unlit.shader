Shader "HDRP/Unlit"
{
    ...
    SubShader
    {
        ...
        Tags{ "RenderPipeline" = "UniversalPipeline" "RenderType" = "HDUnlitShader" }
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/ShaderPass/UnlitDepthPass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/UnlitData.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/Unlit.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/ShaderPass/UnlitSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/UnlitData.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/ShaderPass/UnlitSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/UnlitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassForwardUnlit.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/Unlit.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/ShaderPass/UnlitDistortionPass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/UnlitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/ShaderPass/ShaderPassDistortion.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/Unlit.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/NormalBuffer.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/StandardLit/StandardLit.hlsl"

            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/UnlitData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Unlit/UnlitRaytracing.hlsl"
