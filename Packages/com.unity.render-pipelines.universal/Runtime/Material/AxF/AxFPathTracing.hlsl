...
#include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/PathTracing/Shaders/PathTracingMaterial.hlsl"
#include "Packages/com.unity.render-pipelines.universal/Runtime/RenderPipeline/PathTracing/Shaders/PathTracingBSDF.hlsl"
...
#if defined(_AXF_BRDF_TYPE_SVBRDF)
#   include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxFPathTracingSVBRDF.hlsl"
#elif defined(_AXF_BRDF_TYPE_CAR_PAINT)
#   include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxFPathTracingCarPaint.hlsl"
#endif
