...
//      [ToggleUI] _EnableFogOnTransparent("Enable Fog", Float) = 1.0
    ...
    #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxFProperties.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxF.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/ShaderPass/AxFDepthPass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxFData.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxF.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/ShaderPass/AxFSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxFData.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxF.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/ShaderPass/AxFConstantPass.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxFData.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define HAS_LIGHTLOOP
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxF.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxFRayTracing.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxF.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxFData.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Runtime/Material/AxF/AxFPathTracing.hlsl"
