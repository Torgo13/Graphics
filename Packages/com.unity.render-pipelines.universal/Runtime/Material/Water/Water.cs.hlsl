...
//
// UnityEngine.Rendering.Universal.Water+MaterialFeatureFlags:  static fields
//
#define MATERIALFEATUREFLAGS_WATER_STANDARD (1)
#define MATERIALFEATUREFLAGS_WATER_CINEMATIC (2)

//
// UnityEngine.Rendering.Universal.Water+BSDFData:  static fields
//
...
//
// UnityEngine.Rendering.Universal.Water+SurfaceData:  static fields
//
...
// Generated from UnityEngine.Rendering.Universal.Water+BSDFData
// PackingRules = Exact
struct BSDFData
{
    float3 diffuseColor;
...
// Generated from UnityEngine.Rendering.Universal.Water+SurfaceData
// PackingRules = Exact
struct SurfaceData
{
    float3 baseColor;
